...
1. Compliments of Ricky earlier in the program
    https://www.youtube.com/watch?v=zRWDJOqeDhg&index=5&list=PLgJ8UgkiorCmEChEWfh7sxPvQwYAx3Kt0&t=0s
...
1.  flaviocopes.com - A list of cool Chrome DevTools Tips and Tricks.  The Chrome DevTools provide an amazing set of tools to help you develop on the Web platform. Here are a few tips you might now know yet.
...
## Github Pull Request, Branching, Merging, & Team Workflow video
1.  Here is a good video on Git branching, merging, and resolving merge conflicts: 
...
1.  Working on an idea for a simple HTMLElement wrapper I stumbled upon the following for Internet&nbsp;Explorer and Chrome: For a given HTMLElement with ID in the DOM tree, it is possible to retrieve...
