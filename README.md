...
1. Create a basic web layout using Bootstrap.
    ...
    >[YouTube Video](https://www.youtube.com/watch?v=Y9rMbKHoTBI)


## Bootstrap Text Layout
1. Practice building grid-based layouts with the Bootstrap CSS framework.
    
    >[YouTube Video](https://www.youtube.com/watch?v=wQovwgW020g)
...
1. An oldie but goodie, Chris Beams writes about the secret art of writing helpful Git commit messages. Here’s why he thinks it’s so important: If you haven’t given much thought to what makes a great Git commit message, it may be the case that you haven’t spent much time using git log and related tools. There is a...
    ...
    >[Article](https://css-tricks.com/how-to-write-a-git-commit-message/)
...
1. this is one of my favorite videos about for loops. It's actually set to a hip-hop track and all about looping over burritos
   ...
   >[for loops](https://www.flocabulary.com/unit/coding-for-loops/)
   >[conditionals](https://www.flocabulary.com/unit/coding-conditionals/)
   >[codin events](https://www.flocabulary.com/unit/coding-events/)
...
1. Google publishes a JavaScript style guide. Here are some key lessons.  For anyone who isn’t already familiar with it, Google puts out a style guide for writing JavaScript that lays out (what Google believes to… 
    ...
    >[Medium Post](https://medium.freecodecamp.org/google-publishes-a-javascript-style-guide-here-are-some-key-lessons-1810b8ad050b)
...
1.  Last week I published this post on the keyword this for beginners. One of the topics that wasn’t covered in that article was arrow…
    ...
    >[Codeburst Article](https://codeburst.io/javascript-arrow-functions-for-beginners-926947fc0cdc)
...
1. JavaScript Event KeyCodes: Keycode testing tool - which keys map to which keycodes
    ...
    >[Event KeyCodes](http://keycode.info/)


## JavaScript
1. What is the Execution Context & Stack in JavaScript? by David Shariff
    
    >[Blog Article](http://davidshariff.com/blog/what-is-the-execution-context-in-javascript/)


## Functions
1. A quick 5 minute read on functions: 
    
    >[Codeburst Article](https://codeburst.io/javascript-functions-understanding-the-basics-207dbf42ed99)
...
1.  A protip by aalaap about math, random, function, javascript, and binary
    ...
    >[Coin Flip Function](https://coderwall.com/p/vcom6g/quick-coin-flip-heads-tails-function-in-javascript)
...
1.  The isNaN() function determines whether a value is NaN or not. Note: coercion inside the isNaN function has interesting rules; you may alternatively want to use Number.isNaN(), as defined in ECMAScript 2015.
    ...
    >[MDN Web Docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/isNaN)
...
1. Here’s an introduction to jQuery via Kahn Academy as well.
    >[Khan Academy Article](https://www.khanacademy.org/computing/computer-programming/html-js-jquery)

2. Good Article on what jQuery is and how it fits in with JS: 
    >[Quora Article](https://www.quora.com/What-is-a-difference-between-jQuery-and-JavaScript)
...
1. General instructions for jQuery Intellisense and plugins for VS Code: 
    ...
    >[Github Instructions](https://gist.github.com/jamescalderon/e6332ed039fd1bdaa710532a56161a28)
...
1. Here's a good article in the differences between an API (in general) and a Web API
    >[Article](https://en.wikipedia.org/wiki/Application_programming_interface)

2. Another place you can also search APIs: 
    >[Programmableweb Site](https://www.programmableweb.com/)

3. What is an API? In English, please. – freeCodeCamp
    >[Article](https://medium.freecodecamp.org/what-is-an-api-in-english-please-b880a3214a82 )

4. What are some fun API's to play with?
    >[Reddit Post](https://www.reddit.com/r/webdev/comments/3wrswc/what_are_some_fun_apis_to_play_with/)
...
1.  HTTP status codes and how to use them in RESTful API or Web Services.
    ...
    >[Tutorial](http://www.restapitutorial.com/httpstatuscodes.html)
...
## FIREBASE Links
   >[Reference](https://firebase.google.com/docs/reference/js/firebase.database.Reference?authuser=0#on)
   >[GSTATIC](https://www.gstatic.com/firebasejs/live/3.0/firebase.js)
...
1.  Super helpful documentation on Node.js
   ...
   >[Node.js Documentation](https://nodejs.org/docs/latest/api/process.html#process_process_argv)

2.  Node.JS Module Patterns: A simple introduction to Node.JS modules by example.
    
    >[Github](https://darrenderidder.github.io/talks/ModulePatterns/#)
...
1.  A node.js driver for mysql. It is written in JavaScript, does not require compiling, and is 100% MIT licensed.
    ...
    >[nmp - mysql package](https://www.npmjs.com/package/mysql#preparing-queries)
...
1.  I want to remove the password for user root in localhost. How can I do that? By mistake I have set the password of root user. That's why phpmyadmin is giving an error: #1045 - Access denied for us...
    ...
    >[Remove Root Password](https://stackoverflow.com/questions/3032054/how-to-remove-mysql-root-password)
...
2. Freesound: collaborative database of creative-commons licensed sound for musicians and sound lovers. Have you freed your sound today?
    ...
    >[Freesound Site](http://www.freesound.org)


## Document Write
1. Why is document.write considered a "bad practice"?
    
    >[Stack Overflow Reference](https://stackoverflow.com/questions/802854/why-is-document-write-considered-a-bad-practice)
...
1. YouTube The Coding Train: Hey this seems relevant to the hw: PS: at the end he gets into why you might care about module.exports 
    ...
    >[Coding Train Video](https://www.youtube.com/watch?v=GQC2lJIAyzM)


## Object Oriented Programming
1. WHy is object oriented programming useful with a role playing game:

    >[Programming Article](https://inventwithpython.com/blog/2014/12/02/why-is-object-oriented-programming-useful-with-a-role-playing-game-example/)
...
1. Let’s start by not rating ourselves as experts in Java, and intermediate in C#. Let’s drop Times New Roman, and remind ourselves that there’s a lot more to be done than squashing all text into a page. (Reading time: 18 min read)
    ...
    >[Resume Article](https://medium.freecodecamp.org/how-to-write-a-good-resume-in-2017-b8ea9dfdd3b9)


## Formating Your Business Cards Articles
1.  Great article about what to put on your business card: 

    >[Business Cards](https://www.linkedin.com/pulse/20140609180534-405325-your-business-card-is-bad-here-are-5-ways-to-make-it-great/)
...
2. MOO | Custom Online Business Printing & Design - Design and print customized Business Cards with MOO! Print a different image on each business card - upload your own design, logo, text and photos online.
    ...
    >[MOO Ordering Site](https://www.moo.com/us/?&utm_source=Google&utm_term=Moo%20cards&utm_campaign=GS-US-Brand-MOO+Cards-E&mkwid=sMNn9kwJ2%7Cpcrid%7C227520433656%7Cpkw%7Cmoo%20cards%7Cpmt%7Ce%7Cpdv%7Cc%7C&viqseg=soho&viqtype=new&viqpr=bc&viqc=us&viqsc=brand&viqpl=MOO+Cards_E&viqcid=166625798&viqmkwid=MNn9kwJ2&gclid=EAIaIQobChMIrovazqrd2gIVgzuBCh0NZQAMEAAYASAAEgI2pfD_BwE)


## Whiteboarding
1. GitBook is where you create, write and organize documentation and books with your team.

    >[Whiteboarding Documentation](https://the-coding-bootcamp.gitbooks.io/whiteboarding-algorithms-and-interview-questions/content/)
...
1. Since we just started covering frameworks, take a look at this url.  It lists the top 8 open source front-end frameworks...with Bootstrap being #1:  
    ...
    >[Frameworks](https://www.keycdn.com/blog/front-end-frameworks/)
...
3.  Data Attributes:
    1. [In HTML](https://www.w3schools.com/tags/att_global_data.asp)
    2. [WHY to use them](https://www.sitepoint.com/how-why-use-html5-custom-data-attributes/)
    3. [Documentation: Set or get data from using jQuery .attr() function](http://api.jquery.com/attr/)
    4. jQuery.data()  - Alternate – be careful, as there are some differences from c above: 
        ...
        >[Data and attr in jQuery](https://www.peterbe.com/plog/data-and-attr-in-jquery)

### Extras:

4. jQuery Pass Attributes to A Self-Closed Element
    [Creating a div element in jQuery](https://stackoverflow.com/questions/867916/creating-a-div-element-in-jquery)
...
1. [Google Maps API](https://www.youtube.com/watch?v=0wpyY948nDE)
2. [Part 1 (Google Books API, AJAX, JSON)](https://www.youtube.com/watch?v=uI_UP0pgsDE)
3. [Part 2 (Google Books API, AJAX, JSON)](https://www.youtube.com/watch?v=4LdTe90dqVE)
4. [jQuery Crash Course [1] - Intro & Selectors](https://www.youtube.com/watch?v=3nrLc_JOF7k)
5. [jQuery Crash Course [2] - Events](https://www.youtube.com/watch?v=VlWsJHsVb-E)
6. [JavaScript Higher Order Functions & Arrays](https://www.youtube.com/watch?v=q4FWSdX55ls)
...
5. Remember, the scss files are in the scss folder and there is a file in there ready for your custom code: `_custom.scss`.  All your production files will live in the public folder.  You will not need to touch the css folder at all.   The index file has a bootstrap starter page built in.  It also uses placeholder images generated by js so you will have to remove the last js file on the page before pushing to production.
   ...
   >[Bootstrap Gulp Zip](zipfiles/bootstrap-gulp.zip)